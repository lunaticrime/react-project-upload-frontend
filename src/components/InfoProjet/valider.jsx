...
export default function Valider({ statusValue, submissionDate }) {
  ...
  return (
    <div className="px-4 sm:px-8 md:px-12 lg:px-20 pb-12 bg-[var(--color-background)] font-poppins text-[var(--color-blue-1)]">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-10 mt-6">
        {statusValue === "pending" ? (
          <>
            <button className="group flex items-center justify-center gap-2 rounded-xl bg-[var(--color-blue-1)] px-5 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-semibold text-[var(--color-background)] shadow-md hover:bg-[var(--color-background)] hover:text-[var(--color-blue-1)] hover:border hover:border-[var(--color-blue-1)] transition-all duration-200 cursor-pointer">
              ✅ Valider
            </button>
            <button className="group flex items-center justify-center gap-2 rounded-xl bg-[var(--color-blue-1)] px-5 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-semibold text-[var(--color-background)] shadow-md hover:bg-[var(--color-background)] hover:text-[var(--color-blue-1)] hover:border hover:border-[var(--color-blue-1)] transition-all duration-200 cursor-pointer">
              ❌ Refuser
