...
const ProfileTabs = () => {
  return (
    <div className="lg:mx-5 lg:p-4 w-full">
...
const Card = ({ title, subtitle, Icon, href }) => {
  return (
    <a
      href={href}
      className="w-[180px] sm:w-[200px] md:w-[220px] lg:w-full py-1 px-2 rounded border-[1px] border-slate-300 relative overflow-hidden group bg-white dark:bg-blue-1-dark flex gap-2 items-center shrink-0"
    >
      ...
      <Icon className="absolute z-10 -top-12 -right-12 text-9xl text-slate-100 dark:text-blue-2-dark group-hover:text-blue-3 dark:group-hover:text-blue-250 group-hover:rotate-12 transition-transform duration-300" />
      ...
      <h3 className="font-medium text-lg text-slate-950 dark:text-blue-50 group-hover:text-white dark:group-hover:text-blue-1-dark relative z-10 duration-300">
        {title}
      </h3>
