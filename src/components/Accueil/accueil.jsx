...
export default function Accueil({ isDarkMode }) {
  ...
  return (
    <div className="h-[calc(100vh-108px)] flex flex-col-reverse lg:flex-row items-center justify-between px-6 lg:px-16 pt-12 lg:py-12 bg-blue-50 dark:bg-blue-2-dark gap-10">
      {/* Left Section */}
