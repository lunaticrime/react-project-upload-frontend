...
const Fonctionnalites = ({ isDarkMode }) => {
  ...
  return (
    <div
      id="fonctionnalites"
      ref={sectionRef}
      className={`scroll-mt-10 flex flex-col items-center justify-center px-6 lg:px-16 py-12 bg-[var(--color-background)] pt-20 transition-all duration-700 ease-in-out ${
    ...
    >
      ...
      <div className="text-center w-full">
        ...
        <Reveal isDarkMode={isDarkMode}>
          <div className="pt-10">
            {/* Features Section */}
            <div className="flex flex-wrap justify-center items-center mx-auto gap-4 w-full p-5">
