...
import { navLinks } from "../../../mockData/dataEspaceAdmin";
import Export from "./Export"; // Import Export component

export default function Example({ userName }) {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
  const [activeLink, setActiveLink] = useState("Accueil");
  const [isExportOpen, setIsExportOpen] = useState(false); // State to toggle Export popup
  ...
  const handleExportClick = () => {
    setIsExportOpen(true); // Open Export popup
  };
